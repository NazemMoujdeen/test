...
public class GeneticAlgorithm {
    ...
    private int elite = 30;
    private int additionalEDA = 50;
    private int regeneration = 100;
    private IndividualImage[] population;
    private boolean finished = false;

    private boolean eda;
    private double[][][] edaMeans;

    private ArrayList<IndividualImage> best = new ArrayList<IndividualImage>();
    ...
    //added getters for the variables
    public IndividualImage[] getPopulation() {
        return population;
    }
    public ArrayList<IndividualImage> getBestHistory() {
        return best;
    }
    public IndividualImage getBestIndividual() {
        if (best.isEmpty()) {
            return null;
        }
        return best.getLast();
